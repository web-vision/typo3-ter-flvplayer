<?php
	...
	***************************************************************/
	...
	class tx_flvplayer_pi1_wizicon {
		...
		function proc($wizardItems) {
			...
			$wizardItems['plugins_tx_flvplayer_pi1'] = array(
				...
				// Icon
				'icon'=>t3lib_extMgm::extRelPath('flvplayer').'pi1/ce_wiz.gif',
		...
		function includeLocalLang() {
			...
			// Include file
			include(t3lib_extMgm::extPath('flvplayer').'locallang.php');
	 ...
	 * XCLASS inclusion
	 */
	if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/flvplayer/pi1/class.tx_flvplayer_pi1_wizicon.php']) {
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/flvplayer/pi1/class.tx_flvplayer_pi1_wizicon.php']);
	}
?>
